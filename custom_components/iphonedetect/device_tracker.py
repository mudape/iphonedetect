...
async def async_setup_entry(
    ...
    coordinator: IphoneDetectUpdateCoordinator = hass.data[DOMAIN]["coordinators"][
        entry.entry_id
    ]
...
class IphoneDetectDeviceTracker(
    CoordinatorEntity[IphoneDetectUpdateCoordinator], BaseTrackerEntity
):
    ...
    def __init__(
        self, entry: ConfigEntry, coordinator: IphoneDetectUpdateCoordinator
    ) -> None:
        ...
        # self._ip_address = entry.options[CONF_IP_ADDRESS]
